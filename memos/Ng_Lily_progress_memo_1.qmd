...
Considering the data is mostly communicated with integers, I would appreciate some insight as to whether I should transform it all into factors, or leave them as integers and then interpret from there. My current plan is to convert the variables with only a few options to character variables, and then keep the other character variables that have 100+ values as integers. I will likely not use the ones with too many variables as predictors.
